         ...
         <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white p-3 md:p-8 font-sans selection:bg-orange-500/30">
            <div className="max-w-[1400px] mx-auto space-y-6 md:space-y-10 relative">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10">
                  ...
                  <div className={`relative overflow-hidden rounded-[2.5rem] p-6 md:p-8 bg-[#1e293b]/60 backdrop-blur-2xl border border-orange-500/30 shadow-[0_0_35px_rgba(249,115,22,0.12)] transition-all hover:scale-[1.03] group ${status.temp > status.tempMax || status.temp < status.tempMin ? 'border-red-500/50 shadow-[0_0_35px_rgba(239,68,68,0.2)]' : ''}`}>
                     ...
                     <div className="flex justify-between items-start mb-4 md:mb-6 relative z-10">
                        <div className="p-3 md:p-4 rounded-2xl bg-orange-500/10 border border-orange-500/20 text-orange-500 group-hover:scale-110 transition-all shadow-inner">
                           <Thermometer size={window.innerWidth < 768 ? 20 : 32} className="animate-pulse" />
                        </div>
                        <div className="flex flex-col items-end gap-1">
                           <span className="text-[7px] md:text-[9px] font-black uppercase text-orange-400 bg-orange-500/10 px-3 py-1 rounded-full border border-orange-500/20">
                              Target: {status.tempMin}-{status.tempMax}°C
                           </span>
                           {(status.temp > status.tempMax || status.temp < status.tempMin) && (
                              <span className="text-[6px] md:text-[8px] font-black uppercase text-red-400 bg-red-500/10 px-2 py-0.5 rounded-full border border-red-500/20 animate-bounce">
                                 CRITICAL TEMP
                              </span>
                           )}
                        </div>
                     ...
                     <p className="text-[8px] md:text-[11px] font-black uppercase text-slate-400 tracking-[0.25em] mb-1 relative z-10">Thermal Status</p>
                     <div className="flex items-baseline gap-2 relative z-10">
                        <span className="text-3xl md:text-6xl font-black text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
                           {status.temp.toFixed(1)}
                        </span>
                        <span className="text-sm md:text-2xl font-black text-orange-500 uppercase">°C</span>
                     </div>

                     {/* Temperature visual meter track */}
                     <div className="w-full h-2 bg-slate-950/80 rounded-full overflow-hidden mt-6 border border-white/5 relative">
                        <motion.div 
                           initial={{ width: '0%' }}
                  ...
                  <div className={`relative overflow-hidden rounded-[2.5rem] p-6 md:p-8 bg-[#1e293b]/60 backdrop-blur-2xl border border-blue-500/30 shadow-[0_0_35px_rgba(59,130,246,0.12)] transition-all hover:scale-[1.03] group ${status.hum < status.humMin ? 'border-yellow-500/50 shadow-[0_0_35px_rgba(234,179,8,0.2)]' : ''}`}>
                     {/* Background decorative soft glow */}
                     ...
                     <div className="flex justify-between items-start mb-4 md:mb-6 relative z-10">
                        <div className="p-3 md:p-4 rounded-2xl bg-blue-500/10 border border-blue-500/20 text-blue-400 group-hover:scale-110 transition-all shadow-inner">
                           <Droplets size={window.innerWidth < 768 ? 20 : 32} className="animate-bounce" />
                        </div>
                        <div className="flex flex-col items-end gap-1">
                           <span className="text-[7px] md:text-[9px] font-black uppercase text-blue-400 bg-blue-500/10 px-3 py-1 rounded-full border border-blue-500/20">
                              Threshold: {status.humMin}%+
                           </span>
                           {status.hum < status.humMin && (
                              <span className="text-[6px] md:text-[8px] font-black uppercase text-yellow-400 bg-yellow-500/10 px-2 py-0.5 rounded-full border border-yellow-500/20 animate-pulse">
                                 DRY WARNING
                              </span>
                           )}
                        </div>
                     ...
                     <p className="text-[8px] md:text-[11px] font-black uppercase text-slate-400 tracking-[0.25em] mb-1 relative z-10">Humid Level</p>
                     <div className="flex items-baseline gap-2 relative z-10">
                        <span className="text-3xl md:text-6xl font-black text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)]">
                           {status.hum.toFixed(0)}
                        </span>
                        <span className="text-sm md:text-2xl font-black text-blue-400 uppercase">%</span>
                     </div>
                  ...
                  <div className={`relative overflow-hidden rounded-[2.5rem] p-6 md:p-8 bg-[#1e293b]/60 backdrop-blur-2xl border transition-all hover:scale-[1.03] group ${status.water ? 'border-cyan-500/30 shadow-[0_0_35px_rgba(6,182,212,0.15)]' : 'border-rose-500/50 shadow-[0_0_40px_rgba(244,63,94,0.25)] animate-pulse'}`}>
                     ...
                     <div className="flex justify-between items-start mb-4 md:mb-6 relative z-10">
                        <div className={`p-3 md:p-4 rounded-2xl shadow-inner ${status.water ? 'bg-cyan-500/10 border border-cyan-500/20 text-cyan-400' : 'bg-rose-500/15 border border-rose-500/30 text-rose-500 animate-spin-slow'}`}>
                           <Waves size={window.innerWidth < 768 ? 20 : 32} />
                        </div>
                        <span className={`text-[7px] md:text-[9px] font-black uppercase px-3 py-1 rounded-full border ${status.water ? 'text-cyan-400 bg-cyan-500/10 border-cyan-500/20' : 'text-rose-400 bg-rose-500/10 border-rose-500/20'}`}>
                           {status.water ? 'TANK HEALTHY' : 'CRITICAL ALERT'}
                        </span>
                     </div>

                     <p className="text-[8px] md:text-[11px] font-black uppercase text-slate-400 tracking-[0.25em] mb-1 relative z-10">Water Tank</p>
                     <div className="flex items-baseline gap-2 relative z-10">
                        <span className={`text-2xl md:text-5xl font-black italic uppercase drop-shadow-[0_4px_12px_rgba(0,0,0,0.5)] ${status.water ? 'text-cyan-400' : 'text-rose-500'}`}>
