                      ...
                      <tbody>
                         {allUsers.map((u, i) => (
                            <tr key={i} className="border-b border-white/5 last:border-0 hover:bg-white/10 transition-all group">
                               <td className="py-6 px-4 font-bold text-slate-200">{u.email}</td>
                               <td className="py-6 px-4 uppercase font-black text-orange-500 text-center tracking-widest">{u.role}</td>
